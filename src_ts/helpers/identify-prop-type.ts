export const isPrimitive = (prop: PropType | { name: string }): prop is PropType$Primitive => (Object.keys(prop).length === 1 && prop.name != null) || (prop.name != null && prop.name === 'Element');
